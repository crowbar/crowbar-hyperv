...
default[:openstack][:ceilometer][:version] = "2014.2"
default[:openstack][:ceilometer][:file] = "ceilometer-2014.2.tar.gz"
default[:openstack][:leilometer][:target] = "#{node[:openstack][:location]}"
...
default[:openstack][:ceilometer][:log_dir] = "C:\\OpenStack\\log\\"
